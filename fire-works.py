...
def update(win, fireworks):
    ...
    # Draw "Happy New Year 2024" text
    font_path = "C://Users//saons//PycharmProjects//Youtube//Unbounded-VariableFont_wght.ttf" # paste your own path
    # font_path = "C://Users//saons//PycharmProjects//Youtube//RockSalt-Regular.ttf"
    font = pygame.font.Font(font_path, 36)
    text = font.render("Happy New Year 2024", True, (198, 214, 21))
    win.blit(text, (DISPLAY_WIDTH // 2 - text.get_width() // 2, 200))

    # Draw "Happy New Year 2024" text
    font_path2 = "C://Users//saons//PycharmProjects//Youtube//RockSalt-Regular.ttf" # paste your own path
    font = pygame.font.Font(font_path2, 20)
    text = font.render("BlackOsRa", True, (232, 87, 9))
    win.blit(text, (DISPLAY_WIDTH // 2 - text.get_width() // 2, 250))
...
# code modified from: https://github.com/abhishekayu/fireworks-in-Python-/blob/main/firew.py
