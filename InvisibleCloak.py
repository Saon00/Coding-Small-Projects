"""
User Guide: Please, use red colored materials for being invisible.
After opening camera, wait for few seconds to adapt with backgrounds.
N.B.: This code is not made by me totally. I followed some resources to complete this.
"""
